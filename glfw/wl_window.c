        ...
        case GLFW_LAYER_SHELL_PANEL:
            switch (window->wl.layer_shell.config.edge) {
                ...
                case GLFW_EDGE_RIGHT:
                    ...
                    break;
                case GLFW_EDGE_NONE:
                    which_anchor = ZWLR_LAYER_SURFACE_V1_ANCHOR_TOP | ZWLR_LAYER_SURFACE_V1_ANCHOR_BOTTOM | ZWLR_LAYER_SURFACE_V1_ANCHOR_LEFT | ZWLR_LAYER_SURFACE_V1_ANCHOR_RIGHT;
                    break;
            }
    }
